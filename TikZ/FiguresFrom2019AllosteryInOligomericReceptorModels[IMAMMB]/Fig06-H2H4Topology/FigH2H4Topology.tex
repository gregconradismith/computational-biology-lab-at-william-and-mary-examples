...
\begin{tikzpicture}[scale=1,style=thick,shorten >=0pt,shorten <=0pt]
    ...
    \begin{scope}[xshift=-3.7cm,yshift=2cm,node distance=1cm]
        \node (LRA) {$b$};
    ...
    \begin{scope}[scale=0.7,shorten >=0pt,shorten <=0pt]
    ...
    \begin{scope}[xshift=2cm,yshift=-2.5cm,xscale=1.2,yscale=1.4,font=\footnotesize,thick]
