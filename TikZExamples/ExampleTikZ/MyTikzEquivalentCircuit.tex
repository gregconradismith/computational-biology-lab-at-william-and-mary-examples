...
\draw[help lines] (0,0) grid (5,7);
\draw[decorate, decoration=cell,rotate around={180:(0,1.25)}] (0,0.5) -- node[left,outer sep=10pt] {$E_K$} ++(0,1.5);
\draw (0,2) -- ++(0,0.5);
\draw[decorate, decoration=resistor] (0,2.5) -- node[left,outer sep=10pt] {$g_K$} ++(0,1.5);
\draw (0,4.0) |- ++(2,0.5);
\draw (2,4.5) circle(2pt) -- ++(0,1) node[above] {$\phi_{out}$} [fill] circle(2pt);
\draw (2,4.5) -| ++(2,-1.5);
\draw[decorate, decoration=capacitor] (4,3) -- node[right,outer sep=10pt] {$C$} ++(0,-1.5);
\draw (4,1.5) |- ++(-2,-1.5);
\draw (2,0) circle(1pt) -- ++(0,-1) node[below] {$\phi_{in}$} [fill] circle(2pt); 
\draw (2,0) -| ++(-2,0.5);
\end{tikzpicture}
...
\draw[help lines] (0,0) grid (5,7);
\draw[decorate, decoration=cell,rotate around={180:(0,1.25)}] (0,0.5) -- node[left,outer sep=10pt] {$E_K$} ++(0,1.5);
\draw (0,2) circle(1pt) -- ++(0,0.5) circle(1pt);
\draw[decorate, decoration=resistor] (0,2.5) -- node[left,outer sep=10pt] {$g_K$} ++(0,1.5);
\draw (0,4.0) circle(1pt) |- ++(2,0.5) circle(1pt);
\draw (2,4.5) circle(2pt) -- ++(0,1) node[above] {$\phi_{out}$} [fill] circle(2pt);
\draw (2,4.5) circle(1pt) -| ++(2,-1.5) circle(1pt);
\draw[decorate, decoration=capacitor] (4,3) -- node[right,outer sep=10pt] {$C$} ++(0,-1.5);
\draw (4,1.5) circle(1pt) |- ++(-2,-1.5) circle(1pt);
\draw (2,0) circle(1pt) -- ++(0,-1) node[below] {$\phi_{in}$} [fill] circle(2pt); 
\draw (2,0) circle(2pt) -| ++(-2,0.5) circle(1pt);
\end{tikzpicture}
...
\draw (0,4.5) circle(1pt) circle(2pt) -- ++(0,-0.5) circle(1pt) circle(2pt);
\draw[decorate, decoration=resistor] (0,2.5) -- node[left,outer sep=10pt] {$g_{Ca}$} ++(0,1.5);
\draw (0,2) circle(1pt) -- ++(0,0.5) circle(1pt);
\draw[decorate, decoration=cell,rotate around={0:(0,1.25)}] (0,0.5) -- node[left,outer sep=10pt] {$E_{Ca}$} ++(0,1.5);
\draw[->] (-0.5,2.25) -- ++(1,2);
\draw (0,0) circle(1pt) circle(2pt) -- ++(0,0.5) circle(1pt);
\end{scope}
% potassium
\begin{scope}[xshift=3cm]
\draw (0,4.5) circle(1pt) circle(2pt) -- ++(0,-0.5) circle(1pt) circle(2pt);
\draw[decorate, decoration=resistor] (0,2.5) -- node[left,outer sep=10pt] {$g_{K}$} ++(0,1.5);
\draw (0,2) circle(1pt) -- ++(0,0.5) circle(1pt);
\draw[decorate, decoration=cell,rotate around={180:(0,1.25)}] (0,0.5) -- node[left,outer sep=10pt] {$E_K$} ++(0,1.5);
\draw[->] (-0.5,2.25) -- ++(1,2);
\draw (0,0) circle(1pt) circle(2pt) -- ++(0,0.5) circle(1pt);
...
\draw (0,4.5) circle(1pt) circle(2pt) -- ++(0,-0.5) circle(1pt) circle(2pt);
\draw[decorate, decoration=resistor] (0,2.5) -- node[left,outer sep=10pt] {$g_{L}$} ++(0,1.5);
\draw (0,2) circle(1pt) -- ++(0,0.5) circle(1pt);
\draw[decorate, decoration=cell,rotate around={180:(0,1.25)}] (0,0.5) -- node[left,outer sep=10pt] {$E_{L}$} ++(0,1.5);
%\draw[->] (-0.5,2.25) -- ++(1,2);
\draw (0,0) circle(1pt) circle(2pt) -- ++(0,0.5) circle(1pt);
\end{scope}
% capacitance
\begin{scope}[xshift=9cm]
\draw (0,4.5) circle(1pt) circle(2pt)-- ++(0,-1.5) circle(1pt);
\draw[decorate, decoration=capacitor] (0,3) -- node[right,outer sep=10pt] {$C$} ++(0,-1.5);
\draw (0,1.5) circle(1pt) circle(2pt)-- ++(0,-1.5) circle(1pt) circle(2pt);
\end{scope}
...
\end{tikzpicture}
\end{center}
\caption{Equivalent circuit for a passive membrane.}
