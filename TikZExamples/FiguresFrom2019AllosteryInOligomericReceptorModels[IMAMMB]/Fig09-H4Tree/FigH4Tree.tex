...
\def\etabbd{\eta_{\b\b\d}}
\def\etabdd{\eta_{\b\d\d}}
\def\etaddd{\eta_{\d\d\d}}

\def\etabbbd{\eta_{\b\b\b\d}}
...
\begin{tikzpicture}[xscale=1.5,yscale=1.6,font=\small,shorten <=2.5pt,shorten >=2.5pt,>=latex']
    ...
    \begin{scope}
        ...
        \node[above of=a4,yshift=10pt,xshift=-6pt] {$4\kappab[a^3]=4\kappab$};

        % ultra
        \draw[<-,thick] (a4) node[below,anchor=north,outer sep=4pt] {$a^4$} to (a3b);
        \draw[<-,thick] (a3b) node[above left,anchor=south east,outer sep=4pt] {$a^3b$} to node[above left,anchor=south east,outer sep=4pt] {$\frac{3}{2}\kappab[a^2b]=\frac{3}{2}\kappab \etabb $} (a2b2) node[above left,anchor=south east,outer sep=4pt] {$a^2b^2$};
        ...
        \draw[<-,thick] (b4) node[above,anchor=south,outer sep=4pt] {$b^4$} to node[above right,anchor=south west,outer sep=4pt] {$4\kappad[b^3]=4\kappad \etabd^3 \etabbd^3 \etabbbd $} (b3d) node[above right,anchor=south west,outer sep=4pt] {$b^3d$};
        ...
        \draw[<-,thick] (abd2) node[above,yshift=10pt,anchor=south,outer sep=4pt] {$abd^2$} to node[above right,anchor=south west,outer sep=1pt] (LABEL) {$\frac{1}{3} \kappad[ad^2]$} (ad3) node[below,anchor=north,outer sep=4pt] {$ad^3$};

        \draw[gray,bend left=15] (LABEL) to +(1,1.5) node[text=black,above right]  {$\frac{1}{3} \kappad \etabd^2 \etads^2 \etabbd \etabdd \etaddd $};

        \draw[<-,thick] (a2b2) to (a2bd);
        \draw[<-,thick] (a2bd) to (a2d2);

        % ultra
        \draw[<-,thick] (a3b) to (a3d) node[below,anchor=north,outer sep=4pt] {$a^3d$};
        ...
        % ultra
        \draw[<-,thick] (a4) to (a3c) node[below,anchor=north,outer sep=4pt,yshift=-2pt] {$a^3c$};
